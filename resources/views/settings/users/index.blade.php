                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-2 text-end">
                                                    <div class="d-flex justify-content-end gap-2">
                                                        <a href="{{ route('users.createuserpermission', Crypt::encrypt($d->id)) }}" class="btn btn-sm btn-outline-info" title="Direct Permission">
                                                            <i class="ti ti-shield-lock"></i>
                                                        </a>
                                                        <a href="{{ route('users.impersonate', Crypt::encrypt($d->id)) }}" class="btn btn-sm btn-outline-warning" title="View As (Impersonate)">
                                                            <i class="ti ti-eye"></i>
                                                        </a>
