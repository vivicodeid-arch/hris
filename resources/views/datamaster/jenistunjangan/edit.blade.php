<form action="{{ route('jenistunjangan.update', Crypt::encrypt($jenistunjangan->kode_jenis_tunjangan)) }}" method="POST" id="formcreateJenisTunjangan">
    ...
    <div class="form-group mb-3">
        <label for="status_tunjangan" class="form-label" style="font-weight: 600;">
            Sifat Tunjangan <span class="text-danger">*</span>
        </label>
        <div class="input-group input-group-merge">
            ...
            <select name="status_tunjangan" id="status_tunjangan" class="form-select" required>
                <option value="1" {{ $jenistunjangan->status_tunjangan === '1' ? 'selected' : '' }}>Tetap</option>
                <option value="0" {{ $jenistunjangan->status_tunjangan === '0' ? 'selected' : '' }}>Tidak Tetap</option>
            </select>
        </div>
    </div>
    <div class="form-group mb-3">
