...
<div class="content">
    ...
    <table style="width: 100%; margin-bottom: 15px;">
        ...
        <tr>
            <td class="label" style="width: 120px; vertical-align: top;">Jabatan</td>
            <td class="colon" style="width: 10px; vertical-align: top;">:</td>
            <td>@{{jabatan_hrd}}</td>
        </tr>
        <tr>
            <td class="label" style="width: 120px; vertical-align: top;">Alamat</td>
            <td class="colon" style="width: 10px; vertical-align: top;">:</td>
    ...
    <table style="width: 100%; margin-bottom: 15px; margin-top: 15px;">
        ...
        <tr>
            <td class="label" style="width: 120px; vertical-align: top;">Tempat, Tgl Lahir</td>
            <td class="colon" style="width: 10px; vertical-align: top;">:</td>
            <td>@{{tempat_lahir}}, @{{tanggal_lahir}}</td>
        </tr>
        <tr>
            <td class="label" style="width: 120px; vertical-align: top;">Pendidikan Terakhir</td>
            <td class="colon" style="width: 10px; vertical-align: top;">:</td>
            <td>@{{pendidikan_terakhir}}</td>
        </tr>
        <tr>
            <td class="label" style="width: 120px; vertical-align: top;">Jenis Kelamin</td>
            <td class="colon" style="width: 10px; vertical-align: top;">:</td>
            <td>@{{jenis_kelamin}}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="label" style="width: 120px; vertical-align: top;">No. KTP / SIM</td>
            <td class="colon" style="width: 10px; vertical-align: top;">:</td>
            <td>@{{no_ktp}}</td>
        </tr>
        <tr>
            <td class="label" style="width: 120px; vertical-align: top;">No. Telepon</td>
            <td class="colon" style="width: 10px; vertical-align: top;">:</td>
            <td>@{{no_hp}}</td>
        </tr>
    </table>
