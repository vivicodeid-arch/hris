<form action="{{ route('kontrak.store') }}" method="POST" id="formKontrak" enctype="multipart/form-data">
    @csrf
    <div class="row">
        ...
        <div class="form-group mb-3">
            <label for="dokumen" style="font-weight: 600" class="form-label">Upload Dokumen Kontrak (PDF, Opsional)</label>
