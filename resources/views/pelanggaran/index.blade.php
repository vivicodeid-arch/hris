                                    ...
                                    <div class="card shadow-none border">
                                        <div class="card-body text-center py-4">
                                            <div class="text-muted">
                                                ...
                                                <p class="mt-2 mb-0">Tidak ada data pelanggaran</p>
                                            </div>
                                        </div>
                                    </div>
                                @endforelse
...
<x-modal-form id="mdlCreatePelanggaran" size="modal-lg" show="loadCreatePelanggaran" title="Tambah Pelanggaran" />
<x-modal-form id="mdlEditPelanggaran" size="modal-lg" show="loadEditPelanggaran" title="Edit Pelanggaran" />
@endsection
