                                ...
                                <div class="card-body p-3" id="container-keterangan">
                                    <div class="row align-items-end mb-2 keterangan-item">
                                        <div class="col-md-11 col-12 mb-2 mb-md-0">
                                            <textarea name="keterangan[]" class="form-control form-control-sm" rows="2" placeholder="Contoh: Kehilangan kunci kendaraan operasional Triton Single Cabin B 9341 SAN..."></textarea>
                                        </div>
                                        <div class="col-md-1 col-12 text-end">
                                            <button type="button" class="btn btn-sm btn-outline-danger btn-hapus-keterangan" disabled>
